# Agent Instructions for stores

## Directory Context
This directory is part of the mongoose.gg project located at: client/src/stores

## Purpose
This directory contains code and resources related to: stores
