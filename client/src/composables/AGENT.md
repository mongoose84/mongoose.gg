# Agent Instructions for composables

## Directory Context
This directory is part of the mongoose.gg project located at: client/src/composables

## Purpose
This directory contains code and resources related to: composables
