      ...
      <div class="showcase-content">
        ...
        <div class="totals-row">
          <div class="total-item">
            <span class="total-count">{{ data.duoTotals.pentaKills }}</span>
            <span class="total-label">Pentas</span>
          </div>
          <div class="total-item">
            <span class="total-count">{{ data.duoTotals.quadraKills }}</span>
            <span class="total-label">Quadras</span>
          </div>
          <div class="total-item">
            <span class="total-count">{{ data.duoTotals.tripleKills }}</span>
            <span class="total-label">Triples</span>
          </div>
          <div class="total-item">
            <span class="total-count">{{ data.duoTotals.doubleKills }}</span>
...
import getDuoMultiKills from '@/assets/getDuoMultiKills.js';
...
async function load() {
  ...
  error.value = null;
  try {
    data.value = await getDuoMultiKills(props.userId);
  } catch (e) {
