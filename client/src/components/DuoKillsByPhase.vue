  ...
  <div class="kills-duration-container">
    ...
    <ChartCard v-else title="🗡️ Kills by Game Length">
      <div class="chart-content">
        ...
        <div class="legend">
          <span class="legend-item"><span class="dot high"></span> High kills</span>
          <span class="legend-item"><span class="dot low"></span> Low kills</span>
        </div>
      </div>
    </ChartCard>
  </div>
...
import getDuoKillsByPhase from '@/assets/getDuoKillsByPhase.js';
...
async function load() {
  ...
  error.value = null;
  try {
    data.value = await getDuoKillsByPhase(props.userId);
  } catch (e) {
