      ...
      <div class="timer-content">
        ...
        <div class="team-summary">
          <div class="summary-item wins">
            ...
            <span class="value">{{ formatSeconds(data.teamAvgTimeDeadWins) }}</span>
          </div>
          <div class="summary-item losses">
            <span class="label">Avg Time Dead in Losses</span>
            <span class="value">{{ formatSeconds(data.teamAvgTimeDeadLosses) }}</span>
          </div>
        </div>
...
import getTeamDeathTimerImpact from '@/assets/getTeamDeathTimerImpact.js';
...
// Find max time dead for scaling bars
...
async function load() {
  ...
  error.value = null;
  try {
    data.value = await getTeamDeathTimerImpact(props.userId);
  } catch (e) {
