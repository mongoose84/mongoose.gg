      ...
      <div class="chart-content">
        ...
        <div class="legend">
          <span class="legend-item">
            <span class="dot low"></span> Low deaths
          </span>
          <span class="legend-item">
            <span class="dot high"></span> High deaths
          </span>
        </div>
      </div>
    </ChartCard>
...
import getTeamDeathsByDuration from '@/assets/getTeamDeathsByDuration.js';
...
async function load() {
  ...
  error.value = null;
  try {
    data.value = await getTeamDeathsByDuration(props.userId);
  } catch (e) {
