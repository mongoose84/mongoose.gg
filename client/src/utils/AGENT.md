# Agent Instructions for utils

## Directory Context
This directory is part of the mongoose.gg project located at: client/src/utils

## Purpose
This directory contains code and resources related to: utils
