# Agent Instructions for router

## Directory Context
This directory is part of the mongoose.gg project located at: client/src/router

## Purpose
This directory contains code and resources related to: router
