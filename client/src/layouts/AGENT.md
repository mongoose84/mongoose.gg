# Agent Instructions for layouts

## Directory Context
This directory is part of the mongoose.gg project located at: client/src/layouts

## Purpose
This directory contains code and resources related to: layouts
