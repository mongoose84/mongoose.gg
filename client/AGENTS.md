...
- Use [frontend.instructions.md](../.github/instructions/frontend.instructions.md) for component, store, styling, and accessibility rules.
- Use [frontend-unit-test.instructions.md](../.github/instructions/frontend-unit-test.instructions.md) for unit test expectations.
- Use [e2e-test.instructions.md](../.github/instructions/e2e-test.instructions.md) for Playwright test scope and quality rules.
