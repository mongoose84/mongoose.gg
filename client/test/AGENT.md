# Agent Instructions for test

## Directory Context
This directory is part of the mongoose.gg project located at: client/test

## Purpose
This directory contains code and resources related to: test
