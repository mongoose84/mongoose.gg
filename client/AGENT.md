# Agent Instructions for client

## Directory Context
This directory is part of the mongoose.gg project located at: client

## Purpose
This directory contains code and resources related to: client
