# Agent Instructions for assets

## Directory Context
This directory is part of the mongoose.gg project located at: client/public/assets

## Purpose
This directory contains code and resources related to: assets
