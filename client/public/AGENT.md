# Agent Instructions for public

## Directory Context
This directory is part of the mongoose.gg project located at: client/public

## Purpose
This directory contains code and resources related to: public
