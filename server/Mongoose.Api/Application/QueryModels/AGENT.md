# Agent Instructions for QueryModels

## Directory Context
This directory is part of the mongoose.gg project located at: server/Application/QueryModels

## Purpose
This directory contains code and resources related to: QueryModels
