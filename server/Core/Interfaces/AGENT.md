# Agent Instructions for Interfaces

## Directory Context
This directory is part of the mongoose.gg project located at: server/Core/Interfaces

## Purpose
This directory contains code and resources related to: Interfaces
