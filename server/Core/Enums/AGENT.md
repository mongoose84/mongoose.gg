# Agent Instructions for Enums

## Directory Context
This directory is part of the mongoose.gg project located at: server/Core/Enums

## Purpose
This directory contains code and resources related to: Enums
