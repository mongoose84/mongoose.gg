# Agent Instructions for Entities

## Directory Context
This directory is part of the mongoose.gg project located at: server/Core/Entities

## Purpose
This directory contains code and resources related to: Entities
