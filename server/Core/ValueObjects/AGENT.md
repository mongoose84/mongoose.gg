# Agent Instructions for ValueObjects

## Directory Context
This directory is part of the mongoose.gg project located at: server/Core/ValueObjects

## Purpose
This directory contains code and resources related to: ValueObjects
