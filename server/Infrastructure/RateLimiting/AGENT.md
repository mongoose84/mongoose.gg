# Agent Instructions for RateLimiting

## Directory Context
This directory is part of the mongoose.gg project located at: server/Infrastructure/RateLimiting

## Purpose
This directory contains code and resources related to: RateLimiting
