...
public class AiSnapshotsRepository : RepositoryBase, IAiSnapshotsRepository
{
    public AiSnapshotsRepository(IDbConnectionFactory factory) : base(factory) {}

    public Task<long> InsertAsync(AiSnapshot s)
    {
    ...
    public Task<AiSnapshot?> GetLatestAsync(string puuid, string contextType, int? queueId)
    {
    ...
    private static AiSnapshot Map(MySqlDataReader r) => new()
    {
        Id = r.GetInt64(0),
        Puuid = r.GetString(1),
