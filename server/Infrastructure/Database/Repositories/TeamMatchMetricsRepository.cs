...
public class TeamMatchMetricsRepository : RepositoryBase, ITeamMatchMetricsRepository
{
    public TeamMatchMetricsRepository(IDbConnectionFactory factory) : base(factory) {}

    public Task UpsertAsync(TeamMatchMetric t)
    {
    ...
    public Task<TeamMatchMetric?> GetAsync(string matchId, int teamId)
    {
    ...
    private static TeamMatchMetric Map(MySqlDataReader r) => new()
    {
        Id = r.GetInt64(0),
