...
public class TeamObjectivesRepository : RepositoryBase, ITeamObjectivesRepository
{
    public TeamObjectivesRepository(IDbConnectionFactory factory) : base(factory) {}

    public Task UpsertAsync(TeamObjective t)
    {
    ...
    public Task<TeamObjective?> GetAsync(string matchId, int teamId)
    {
    ...
    private static TeamObjective Map(MySqlDataReader r) => new()
    {
        Id = r.GetInt64(0),
