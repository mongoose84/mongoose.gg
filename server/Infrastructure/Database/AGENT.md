# Agent Instructions for Database

## Directory Context
This directory is part of the mongoose.gg project located at: server/Infrastructure/Database

## Purpose
This directory contains code and resources related to: Database
