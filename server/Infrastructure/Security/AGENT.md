# Agent Instructions for Security

## Directory Context
This directory is part of the mongoose.gg project located at: server/Infrastructure/Security

## Purpose
This directory contains code and resources related to: Security
