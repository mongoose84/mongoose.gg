# Agent Instructions for Serialization

## Directory Context
This directory is part of the mongoose.gg project located at: server/Infrastructure/Serialization

## Purpose
This directory contains code and resources related to: Serialization
