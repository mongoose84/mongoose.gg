# Agent Instructions for Infrastructure

## Directory Context
This directory is part of the mongoose.gg project located at: server/Infrastructure

## Purpose
This directory contains code and resources related to: Infrastructure
