...
public class SubscriptionEventsRepository : RepositoryBase
{
    ...
    public async Task<long> InsertAsync(SubscriptionEvent ev)
    {
    ...
    public Task<IList<SubscriptionEvent>> GetBySubscriptionIdAsync(long subscriptionId)
    {
    ...
    private static SubscriptionEvent Map(MySqlDataReader r) => new()
    {
