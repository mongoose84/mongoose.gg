...
public class SubscriptionsRepository : RepositoryBase
{
    public SubscriptionsRepository(IDbConnectionFactory factory) : base(factory) {}

    public async Task<long> UpsertAsync(Subscription sub)
    {
    ...
    public Task<Subscription?> GetByUserIdAsync(long userId)
    {
    ...
    private static Subscription Map(MySqlDataReader r) => new()
    {
