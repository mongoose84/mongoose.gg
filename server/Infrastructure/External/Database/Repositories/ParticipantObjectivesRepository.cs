...
public class ParticipantObjectivesRepository : RepositoryBase
{
    ...
    public Task UpsertAsync(ParticipantObjective o)
    {
    ...
    public Task<ParticipantObjective?> GetByParticipantIdAsync(long participantId)
    {
    ...
    private static ParticipantObjective Map(MySqlDataReader r) => new()
    {
        Id = r.GetInt64(0),
