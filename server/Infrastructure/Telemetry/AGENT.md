# Agent Instructions for Telemetry

## Directory Context
This directory is part of the mongoose.gg project located at: server/Infrastructure/Telemetry

## Purpose
This directory contains code and resources related to: Telemetry
