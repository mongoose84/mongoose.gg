# Agent Instructions for WebSocket

## Directory Context
This directory is part of the mongoose.gg project located at: server/Infrastructure/WebSocket

## Purpose
This directory contains code and resources related to: WebSocket
