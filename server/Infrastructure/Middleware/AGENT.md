# Agent Instructions for Middleware

## Directory Context
This directory is part of the mongoose.gg project located at: server/Infrastructure/Middleware

## Purpose
This directory contains code and resources related to: Middleware
