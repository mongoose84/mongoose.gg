# Agent Instructions for Configuration

## Directory Context
This directory is part of the mongoose.gg project located at: server/Infrastructure/Configuration

## Purpose
This directory contains code and resources related to: Configuration
