# Agent Instructions for Riot

## Directory Context
This directory is part of the mongoose.gg project located at: server/Infrastructure/Riot

## Purpose
This directory contains code and resources related to: Riot
