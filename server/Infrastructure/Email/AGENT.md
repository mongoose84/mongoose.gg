# Agent Instructions for Email

## Directory Context
This directory is part of the mongoose.gg project located at: server/Infrastructure/Email

## Purpose
This directory contains code and resources related to: Email
