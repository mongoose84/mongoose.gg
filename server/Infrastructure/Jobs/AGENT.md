# Agent Instructions for Jobs

## Directory Context
This directory is part of the mongoose.gg project located at: server/Infrastructure/Jobs

## Purpose
This directory contains code and resources related to: Jobs
