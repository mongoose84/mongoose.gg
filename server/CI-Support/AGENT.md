# Agent Instructions for CI-Support

## Directory Context
This directory is part of the mongoose.gg project located at: server/CI-Support

## Purpose
This directory contains code and resources related to: CI-Support
