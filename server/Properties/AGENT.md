# Agent Instructions for Properties

## Directory Context
This directory is part of the mongoose.gg project located at: server/Properties

## Purpose
This directory contains code and resources related to: Properties
