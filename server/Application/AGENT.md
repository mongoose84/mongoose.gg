# Agent Instructions for Application

## Directory Context
This directory is part of the mongoose.gg project located at: server/Application

## Purpose
This directory contains code and resources related to: Application
