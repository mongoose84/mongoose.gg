# Agent Instructions for DTOs

## Directory Context
This directory is part of the mongoose.gg project located at: server/Application/DTOs

## Purpose
This directory contains code and resources related to: DTOs
