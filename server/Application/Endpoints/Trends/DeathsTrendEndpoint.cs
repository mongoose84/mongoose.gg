    ...
    public void Configure(WebApplication app)
    {
        ...
        ) =>
        {
            try
            {
                ...
                {
                    logger.LogWarning("Deaths trend: invalid userId format {UserId}", LogSanitizer.Sanitize(userId));
                ...
                {
                    logger.LogWarning("Deaths trend: user {AuthUserId} attempted to access data for user {RouteUserId}",
                ...
                {
                    logger.LogWarning("Deaths trend: no riot accounts found for userId {UserId}", userIdInt);
