# Agent Instructions for Endpoints

## Directory Context
This directory is part of the mongoose.gg project located at: server/Application/Endpoints

## Purpose
This directory contains code and resources related to: Endpoints
