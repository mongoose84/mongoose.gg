# Agent Instructions for migrations

## Directory Context
This directory is part of the mongoose.gg project located at: server/migrations

## Purpose
This directory contains code and resources related to: migrations
