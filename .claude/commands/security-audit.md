...
argument-hint: optional file/component/branch scope; defaults to current branch vs origin/main
model: sonnet
---
...
- Use `CLAUDE.md` and `.github/specs/architecture.spec.md` for project-specific security rules.
