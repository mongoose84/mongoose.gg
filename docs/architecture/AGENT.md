# Agent Instructions for architecture

## Directory Context
This directory is part of the mongoose.gg project located at: docs/architecture

## Purpose
This directory contains code and resources related to: architecture
