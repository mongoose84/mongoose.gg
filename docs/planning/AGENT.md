# Agent Instructions for planning

## Directory Context
This directory is part of the mongoose.gg project located at: docs/planning

## Purpose
This directory contains code and resources related to: planning
