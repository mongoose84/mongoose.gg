# Agent Instructions for competitors

## Directory Context
This directory is part of the mongoose.gg project located at: docs/competitors

## Purpose
This directory contains code and resources related to: competitors
