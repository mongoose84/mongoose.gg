# Agent Instructions for ui-ux

## Directory Context
This directory is part of the mongoose.gg project located at: docs/ui-ux

## Purpose
This directory contains code and resources related to: ui-ux
