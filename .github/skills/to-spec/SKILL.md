...
3. Write the spec using the template below, then publish it as `.github/specs/features/<kebab-name>.spec.md`. Set `> **Triage**: ready-for-agent` in the header - no need for additional triage.
