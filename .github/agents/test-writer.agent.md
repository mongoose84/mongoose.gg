...
1. The targeted instruction file for the stack:
...
4. [test-strategy.spec.md](../specs/test-strategy.spec.md) only when changing test scope or infrastructure.

## Workflow

1. Detect the stack from the target file or folder.
2. Follow the targeted instruction file for coverage expectations and helpers.
